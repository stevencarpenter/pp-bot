#!/usr/bin/env python3
"""Generate all GitHub issue files for pp-bot repository"""

import os

# Read the issue body we already created
...
print("Generating issue markdown files...")

for issue in issues_data[:2]:  # Start with first 2 issues
    filename = f"issue-{issue['number']:02d}.md"
...
print("\n✅ Issue markdown files generated successfully!")
