...
import { getUserScore, updateUserScore, getTopUsers, recordVote } from './storage/database';
  ...
  app.message(async ({ message, say }) => {
    try {
      ...
      for (const vote of votes) {
        ...
        await recordVote((message as any).user, vote.userId, vote.action, (message as any).channel, (message as any).ts);
